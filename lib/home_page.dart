...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    final config = PaymentConfig(
      ...
      productName: 'Dell G5 G5510 2021 i7 10th Gen 8 Core / RTX 3060 / 16GB RAM / 512GB SSD / 15.6" 165Hz FHD Display',
      productUrl: 'https://www.sastodeal.com/dell-g5-g5510-2021-i7-10th-gen-8-core-rtx-3060-16gb-ram-512gb-ssd-15-6-165h-itti-g5510.html',
      additionalData: {
        'vendor': 'Sastodeal',
        'image_url':
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            //               context.read<AppPreferenceNotifier>().updateBrightness(isDarkMode: isDarkMode);
            //             },
            //           ),
            //           ListTile(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text('First Product', style: Theme.of(context).textTheme.bodyText2),
                          const Spacer(),
                          Text('Rs: ${amountInPaisa / 100}'),
                        ],
                      ),
                    ],
                  ),
